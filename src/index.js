...
var bossMonster = { x: 0, y: 0, alive: true };
var skeleton1 = { x: 0, y: 0, alive: true };
var skeleton2 = { x: 0, y: 0, alive: true };
var skeleton3 = { x: 0, y: 0, alive: true };
...
function checkIfMoveAllowed() {
    for (var i = 0; i < wallPositionList.length; i++) {
        makeDestination();
        if (destination[0] == wallPositionList[i][0] && destination[1] == wallPositionList[i][1])
            return false;
    }
    return true;
}

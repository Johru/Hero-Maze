...
export function renderMonster(specimen: Monster): void {
  if (specimen.alive&&specimen.x-scrollingModifierX<10&&specimen.y-scrollingModifierY) {
    ctx.drawImage(
  ...
  } else if(specimen.x-scrollingModifierX<10&&specimen.y-scrollingModifierY) {
    ctx.drawImage(
      blood,
      (specimen.x - 1-scrollingModifierX) * tileWidth,
      (specimen.y - 1-scrollingModifierY) * tileWidth,

...
export function randomizeFloor(): void {
  ...
  console.log(`${stopIfInfinite} attempts were needed to place floor tiles.`);
  stopIfInfinite = 0;
}
...
export function checkIfAlreadyFloor(x: number, y: number): boolean {

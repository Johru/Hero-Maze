...
},{"./random":6,"./utility":7,"./variables":8}],2:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
function printstats() {
    ...
    if (variables_1.bossMonster.alive) {
        variables_1.ctx.fillText("Boss is still alive!", 660, 200);
    }
    else {
        variables_1.ctx.fillText("Boss is dead. Congrats.", 660, 200);
    }
    variables_1.ctx.fillText("HP:       ".concat(variables_1.bossMonster.HP), 660, 225);
    variables_1.ctx.fillText("DP:       ".concat(variables_1.bossMonster.DP), 660, 250);
    variables_1.ctx.fillText("SP:       ".concat(variables_1.bossMonster.SP), 660, 275);
...
function renderMonster(specimen) {
    if (specimen.alive && specimen.x - index_1.scrollingModifierX < 10 && specimen.y - index_1.scrollingModifierY) {
    ...
    else if (specimen.x - index_1.scrollingModifierX < 10 && specimen.y - index_1.scrollingModifierY) {
...
function attemptToMoveMonster(specimen) {
    if (specimen.alive) {
        ...
        while (!hasMoved) {
            ...
            if ((0, utility_1.checkIfMoveAllowed)() && checkOtherMonsters(specimen)) {
...
function checkIfBattleForMonsters() {
    for (var _i = 0, monsterList_3 = variables_1.monsterList; _i < monsterList_3.length; _i++) {
        ...
        if (variables_1.heroStats.x == monster.x && variables_1.heroStats.y == monster.y && monster.alive) {
            (0, utility_1.battle)(monster);
        }
    }
}
...
},{"./hero":2,"./monster":5}],7:[function(require,module,exports){
"use strict";
exports.__esModule = true;
